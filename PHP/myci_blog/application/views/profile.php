...
<div class="MainForm">
<form class="AutoCommitJSONForm" action="user/editProfile" method="POST">
<table>
	<tbody><tr>
		<th>登录帐号</th>		
		<td>
	...
	<tr>
		<th>姓名</th>		
		<td>
			<input id="username" name="realName" size="20" maxlength="20" class="TEXT" value="<?php echo $this->session->userdata("userinfo")->realName?>" type="text">
	...
	<tr>
    	<th>性别</th>		
		<td>
			<input id="male" name="gender" value="男" checked="checked" type="radio">男
...
<script src="profile1_files/getcity.js"></script></td>
	...
	<tr class="submit">
		<th></th>
		<td>
		<input id="sub" value="保存修改" class="BUTTON SUBMIT" type="submit">
