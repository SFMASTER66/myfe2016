...
<?php include "same.php" ?>
    ...
    <div id="AdminContent">
<div class="MainForm">
<form id="BlogForm" action="blog/saveblogs" method="POST">
<input id="hdn_blog_id" name="draft" value="0" type="hidden">
  <table>
  <tbody><tr><td class="t">标题（必填）</td></tr>
  <tr>
	<td>
    <input name="blogtitle" id="f_title" class="TEXT" style="width: 400px;" type="text">
	存放于
		<?php
		echo "<select name='blogTypeid'>";
		foreach($blogTypeName as $typeName){
			echo "<option value='$typeName->type_id'>".$typeName->type_name."</option>";
		}
		echo "</select>";
		?>
<!--	<select name="catalog">-->
