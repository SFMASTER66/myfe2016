...
<div id="OSC_Screen"><!-- #BeginLibraryItem "/Library/OSC_Banner.lbi" -->
    ...
    <div id="OSC_Content">
        <div id="AdminScreen">
            ...
            <div id="AdminContent">
                <div class="MainForm">
                    <form id="BlogForm" action="blog/updateblogs" method="POST">
                        <input id="hdn_blog_id" name="draft" value="0" type="hidden">
                        <table>
                            <tbody><tr><td class="t">标题（必填）</td></tr>
                            <tr>
                                <td>
                                    <input name="blogtitle" id="f_title" class="TEXT" style="width: 400px;" type="text" value="<?php echo $blogTypeNames->title?>">
                                    <input name="blogId" type="hidden" value="<?php echo $blogTypeNames->blog_id?>">
                                    存放于
                                    <?php
                                    echo "<select name='blogTypeid'>";
                                    foreach($blogTypeName as $row){
                            ...
                            <tr>
                                ...
                                <td><textarea name="content" id="ta_blog_content" style="width:750px;height:300px;"><?php echo $blogTypeNames->content?></textarea></td>
                            </tr>
                            <tr class="option">
